...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $_SESSION['suggested'] = $_POST['suggested'];
        $_SESSION['trendx'] = $_POST['trendx'];
        $_SESSION['falcon'] = $_POST['falcon'];
        $_SESSION['mtf'] = $_POST['mtf'];
        $_SESSION['notes'] = $_POST['notes'];
        $_SESSION['trendx_eq'] = $_POST['trendx_eq'];
        $_SESSION['vsdt_eq'] = $_POST['vsdt_eq'];
        $_SESSION['mtf_eq'] = $_POST['mtf_eq'];
        $_SESSION['suggested_eq'] = $_POST['suggested_eq'];
        $_SESSION['falcon_eq'] = $_POST['falcon_eq'];
    }

    if ($_SESSION['sourced_from'] or $_SESSION['sourced_to'] or $_SESSION['suggested'] or $_SESSION['vsdt'] or $_SESSION['sha1'] or $_SESSION['trendx'] or $_SESSION['falcon'] or $_SESSION['notes'] or $_SESSION['mtf']) {  
        ...
        if ($_SESSION['suggested']) {
            if (!$first) $and = " AND ";
            else $first = False;
            if($_SESSION['suggested_eq'] == "eq") {
                $_SESSION['filter_query'] .= $and . " suggested = ";
                if($_SESSION['suggested'] == 'None')  $_SESSION['filter_query'] .= " '' ";
                else  $_SESSION['filter_query'] .= " '" . $_SESSION['suggested'] . "' ";
            } elseif($_SESSION['suggested_eq'] == "neq") {
                $_SESSION['filter_query'] .= $and . " suggested != ";
                if($_SESSION['suggested'] == 'None')  $_SESSION['filter_query'] .= " '' ";
                else  $_SESSION['filter_query'] .= " '" . $_SESSION['suggested'] . "' ";
            } else $_SESSION['filter_query'] .= $and . " suggested LIKE '%" . $_SESSION['suggested'] . "%'";
        } 
        ...
        if ($_SESSION['falcon']) {
            ...
            if($_SESSION['falcon_eq'] == "eq") {
                $_SESSION['filter_query'] .= $and . " falcon = ";
                if($_SESSION['falcon'] == 'None')  $_SESSION['filter_query'] .= " '' ";
                else  $_SESSION['filter_query'] .= " '" . $_SESSION['falcon'] . "' ";
            } elseif($_SESSION['falcon_eq'] == "neq") {
                $_SESSION['filter_query'] .= $and . " falcon != ";
                if($_SESSION['falcon'] == 'None')  $_SESSION['filter_query'] .= " '' ";
                else  $_SESSION['filter_query'] .= " '" . $_SESSION['falcon'] . "' ";
            } else $_SESSION['filter_query'] .= $and . " falcon LIKE '%" . $_SESSION['falcon'] . "%'";
        } 
        ...
        if ($_SESSION['mtf']) {
            ...
            if($_SESSION['mtf_eq'] == "eq") {
                $_SESSION['filter_query'] .= $and . " mtf = ";
                if($_SESSION['mtf'] == 'None')  $_SESSION['filter_query'] .= " '' ";
                else  $_SESSION['filter_query'] .= " '" . $_SESSION['mtf'] . "' ";
            } elseif($_SESSION['mtf_eq'] == "neq") {
                $_SESSION['filter_query'] .= $and . " mtf != ";
                if($_SESSION['mtf'] == 'None')  $_SESSION['filter_query'] .= " '' ";
                else  $_SESSION['filter_query'] .= " '" . $_SESSION['mtf'] . "' ";
            } else $_SESSION['filter_query'] .= $and . " mtf LIKE '%" . $_SESSION['mtf'] . "%'";
        }   
        ...
        <div class="main">
            <div style="text-align: center;" class="inline-buttons">
                <div class="column">
                    ...
                    <a class="ui small teal button" href="trendslice_filter.php" target="_blank"><i class="chart pie icon"></i> CHART</a>
                        ...
                        <tbody style="font-size: 105%;">
                            <?php while($row = mysqli_fetch_assoc($page_result)) { $currsamp_id = $row['id'];?>
                                <tr style = "text-align: center">
                                    ...
                                    <td nowrap title="Suggest"><?php echo $row['suggested'] ?></td>
...
<?php startblock('extrascripts') ?>
    <script>
        ...
        rpp_input.addEventListener("keydown", function (e) {
            if (e.keyCode === 13) {
                window.location.href = "trend_filter.php?rpp=" + rpp_input.value;
            }
        });
        ...
        function change_page(next) {
            ...
            window.location.href = "trend_filter.php?page=" + temp; 
        }
