		...
		for($i = 1; $i < 14; $i++) {
            ...
            if($line[$temp] == "1") {
				if($temp == 0) {
					...
					echo '<script> setTimeout(function(){ window.open("trendslice_monthly.php"); }, ';
					echo $saved_interval;
					echo '000); </script>';
					echo '<script type="text/javascript">setTimeout("window.close();", ';
					echo $saved_interval;
					...
					echo '<script> setTimeout(function(){ window.open("trendslice_overall.php"); }, ';
					echo $saved_interval;
					echo '000); </script>';
					echo '<script type="text/javascript">setTimeout("window.close();", ';
					echo $saved_interval;
				...
				elseif($temp == 11) {
					echo '<script> setTimeout(function(){ window.open("trendxdoubleline_overall.php"); }, ';
					echo $saved_interval;
					echo '000); </script>';
					echo '<script type="text/javascript">setTimeout("window.close();", ';
					echo $saved_interval;
				...
				elseif($temp == 12) {
					echo '<script> setTimeout(function(){ window.open("trend_dashboard.php"); }, ';
					echo $saved_interval;
					echo '000); </script>';
					echo '<script type="text/javascript">setTimeout("window.close();", ';
					echo $saved_interval;
