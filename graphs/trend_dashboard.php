...
<!-- Styles -->
<style>
body { background-color: #061726; color: #fff;  font-family: Arial, Helvetica, sans-serif;}
...
<center><!--<h1>Competitive Intelligence</h1>-->
    <h1 style = "font-size:50px;">TRENDX</h1>
    <h1 style = "font-size:30px;">Monthly (<?php echo $date_from . " to " . $date_to?>)</h1>
  </center>
  <br>
<html>
<meta http-equiv="refresh" content="3600" >
<div id="chartContainer2" style="width: 50%; height: 800px;display: inline-block; background-color:#030B16;  border: 5px solid  #061726;" ></div>
<div id="chartContainer1" style="width: 49%; height: 800px;display: inline-block; background-color:#030B16;  border: 5px solid  #061726;" ></div>
<div id="chartContainer3" style="width: 50%; height: 800px;display: inline-block; background-color:#030B16;  border: 5px solid  #061726;" ></div>
<div id="chartContainer4" style="width: 49%; height: 800px;display: inline-block; background-color:#030B16;  border: 5px solid  #061726;" ></div>
</html>
<?php
