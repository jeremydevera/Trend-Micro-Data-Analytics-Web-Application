		...
		?>
				...
				<div class="col-sm-offset-2 col-sm-10" style="position: static; z-index: -1;">
					...
					<form class="horizontal" action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<table>
											<tbody>
											<tr>
												<td style="text-align: right; vertical-align: middle;" style="width: 20%">Source : &nbsp</td>
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Date Sourced From :&nbsp</td>
												<td style="width: 33%;" height="40">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">SHA-1 : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">ADC : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Other Detection : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">File Detection : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">TrendX : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Trigger : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
														<select name="trigger_search" class="form-control">
															...
															?>
															<?php while($row = mysqli_fetch_array($result)):; ?>
															<option value="<?php echo $row['name'];?>" <?php if($trigger_search == $row['name']) echo "selected"; ?> ><?php echo $row['name']; ?></option>
															<?php endwhile; ?>
														</select>
													</div>
												</td>
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Prevalence From : &nbsp</td>
												<td height="40">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Path : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Analyze : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Date Tested From : &nbsp</td>
												<td height="40">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Tester : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
											...
											<tr>
												<td style="text-align: right; vertical-align: middle;">Notes : &nbsp</td>
												<td height="40" colspan="3">
													<div class="input-group col-xs-12">
										...
										<div style="margin-top: 10px;" class="input-group col-xs-12">
						...
						<a type="submit" href="create.php" class='btn btn-success btn-sm' name="create" data-toggle='tooltip' title='Create'><span style="position: static; z-index: -1;" class='glyphicon glyphicon-plus'></span> CREATE</a>
						...
						<?php
							...
							// Samples Table
							echo "<br<br><br><br>
							<div class='table' style='position: static; z-index: -1;'>
							...
							echo "<div class='col-sm-12' style='position: static; z-index: -1;'>";
								...
								echo "<select name='page' style='padding: 5px; margin-bottom:10px; class='btn btn-default btn-sm' id='page' onchange='change_page(-1)'>";
									...
									$chunk = 10**(strlen(ceil($asdf/10)));
									for($p=1; $p<=$total; $p++) {
										if(($p < 10*ceil($current/10 - 1) + 10 and $p > 10*ceil($current/10 - 1)) or $p%10 == 0) {
