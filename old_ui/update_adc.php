...
<?php
    ...
    $conn=mysqli_connect("localhost", "root", "","charles_db");
        ...
        if(isset($_GET["update"])){
            $id = $_GET["update"];
            $sql_select = "SELECT * FROM charles_table_adc WHERE id='$id'";
        ...
        if(isset($_POST["create"])){
          $name = $_POST['name'];
          $value = $_POST['value'];
          $query = "SELECT * FROM charles_table_adc WHERE name='$name'";
          ...
          $query = "SELECT * FROM charles_table_adc WHERE name='$value'";
          $result = mysqli_query($conn, $query);
          ...
          if(empty($name_error) && empty($value_error)){
                $sql_update = "UPDATE charles_table_adc SET name='$name', value='$value' WHERE id='$id'";
...
<body>
    ...
    <div class="col-sm-10">
       ...
       <div class="col-sm-offset-3 col-sm-6">
        <br><br><br>
        <h3 class="text-center">UPDATE ADC</h3><br>
