...
<body>
    ...
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <a href='create_account.php' class='btn btn-success btn-sm' data-toggle='tooltip' title='Create'><span class='glyphicon glyphicon-plus'> CREATE</span></a>
        <?php
          $page = 0;
          ...
          $query_count = "SELECT * FROM charles_table_users ORDER by id desc";
          $result_count = mysqli_query($conn, $query_count);
          $row_count = mysqli_num_rows($result_count);

          $query = "SELECT * FROM charles_table_users ORDER by id desc LIMIT $page, 10";
            ...
            echo "<td>" .
              "<div class='dropdown'>
                ...
                <ul class='dropdown-menu'>
                  <li><a href='update_users.php?update=$row[id]'>Update</a></li>
                  <li><a href='delete_users.php?delete=$row[id]'>Delete</a></li>
                </ul>
              </div>" . "</td><td>"
              . $row['username'] . "</td><td>" . md5($row['password']) . "</td><td>"
              . "</td></tr>";
          }
