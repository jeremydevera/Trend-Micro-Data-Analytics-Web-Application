...
<body>
    ...
    <a href='create_source.php' class='btn btn-success btn-sm' data-toggle='tooltip' title='Create'><span class='glyphicon glyphicon-plus'></span> CREATE</a>
        ...
        <?php
          ...
          while($row = mysqli_fetch_assoc($result)){
            echo "<td>" .
             ...
             . $row['name'] . "</td><td>" . $row['value'] . "</td></tr>";
          }
