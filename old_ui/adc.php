...
<body>
    ...
    <h3 class="text-center">ADC</h3>
    <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    <a href='create_adc.php' class='btn btn-success btn-sm' data-toggle='tooltip' title='Create'><span class='glyphicon glyphicon-plus'></span> CREATE</a>
        <?php
          $page = 0;
          ...
          while($row = mysqli_fetch_assoc($result)){
            echo "<td>" .
              ...
              . $row['name'] . "</td><td>" . $row['value'] . "</td><td>"
              . "</td></tr>";
          }
